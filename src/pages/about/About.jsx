            ...
            <code className="about-code">
                ...
                <span className="blue about-one">const </span><span className="pink">BYSTAS</span> = [<br/>
                    <span className="about-two">&#123;</span><br/>
                        ...
                        <span className="about-three">year: </span><span className="k">'116',</span><br/>
                    ...
                    <span className="k">'HTML', </span>
                        ...
                        <span className="k">'SCSS', </span>
                        <span className="k">'JavaScript', </span>
                        <span className="k">'TypeScript', </span>
                        <span className="k">'React', </span>
                        <span className="k">'Redux', </span>
                        <span className="k">'Redux-Toolkit' </span>
                    </div>
                <span className="about-one">]</span> <br/>
                <span>&#125;</span>
                </div>
